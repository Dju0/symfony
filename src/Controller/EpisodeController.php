...
class EpisodeController extends AbstractController
{
    ...
    public function edit(string $slug, EpisodeRepository $episodeRepository, Request $request, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
    {
        $episode = $episodeRepository->findOneBy(['slug' => $slug]);
        $form = $this->createForm(EpisodeType::class, $episode);
        $form->handleRequest($request);
